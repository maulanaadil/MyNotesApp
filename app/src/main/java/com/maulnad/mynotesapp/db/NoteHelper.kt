...
import com.maulnad.mynotesapp.db.DatabaseContract.NoteColumns.Companion._ID
import java.sql.SQLException

class NoteHelper(context: Context) {

    companion object {
        fun getInstance(applicationContext: Context): NoteHelper = INSTANCE
            ?: synchronized(this) {
            INSTANCE
                ?: NoteHelper(applicationContext)
        }
